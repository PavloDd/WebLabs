...
//   window.location.href = "/Lab_5/creationPage.html"
// }
...
//         data.forEach(plate => {
//           const { id, title, description, cost, type } = plate;
//           const newPlateDiv = document.createElement("div");
//           newPlateDiv.classList.add("plateInfo");
//           newPlateDiv.setAttribute("data-plate-id", id);
...
//               <button class="editButton" onclick="editButton(${id}, '${title}', '${description}', ${cost}, '${type}')">Edit</button>
//             </div>
//           `;
...
//   fetch('http://localhost:3000/insert-plate', {
//     method: 'POST',
//     headers: {
...
//   fetch(`http://localhost:3000/delete-plate/${plateId}`, {
//     method: 'DELETE',
//   })
//     .then(response => {
//       if (!response.ok) {
//         throw new Error('Network response was not ok');
//       }
//       const plateDiv = document.querySelector(`[data-plate-id="${plateId}"]`);
//       if (plateDiv) {
//         plateDiv.remove();
//       }
//       return response.json();
//     })
//     .then(data => {
//       console.log('Plate deleted:', data);
//     })
//     .catch(error => {
//       console.error('Error:', error);
//     });
...
//   fetch(`http://localhost:3000/save-edits/${plateId}`, {
//     method: 'PUT',
//     headers: {
//       'Content-Type': 'application/json',
//     },
